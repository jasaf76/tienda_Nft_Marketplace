const _1_Migration_MetaDappToken = require("../1_Migration_MetaDappToken");
// @ponicode
describe("_1_Migration_MetaDappToken", () => {
  test("0", () => {
    let result = _1_Migration_MetaDappToken({
      deploy: () =>
  ...
  test("5", () => {
    let result = _1_Migration_MetaDappToken({ deploy: () => "" });
    expect(result).toMatchSnapshot();
  });
});
